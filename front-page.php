<?php get_header();?>
            ...
            <div class="h-padding" id="frnt-hero-area">
                ...
                <div id="frnt-hero-right">
                    <div id="left-pic-col">
                        <div id="left-top-pic">
                            <img src="<?php echo get_template_directory_uri().'/images/ceylon-hero-one.png'?>"alt="">
                        </div>
                        <div id="left-btm-pic">
                            <img src="<?php echo get_template_directory_uri().'/images/ceylon-hero-two.png'?>"  alt="">
                        </div>
                    </div>
                    <div id="right-pic-col">
                        <div id="right-top-pic">
                            <img src="<?php echo get_template_directory_uri().'/images/ceylon-hero-three.png'?>"  alt="">
                        </div>
                        <div id="right-btm-pic">
                            <img src="<?php echo get_template_directory_uri().'/images/ceylon-hero-four.png'?>"  alt="">
                        </div>
                    </div>
                </div>
            </div>
